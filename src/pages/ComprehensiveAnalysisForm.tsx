      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {['Domestic', 'Europe', 'North America', 'Asia', 'Middle East', 'Other'].map((market) => (
              <div key={market} className="flex items-center space-x-2">
                <Checkbox
                  id={market}
                  checked={businessData.currentMarkets.includes(market)}
                  onCheckedChange={(checked) => handleCheckboxChange('currentMarkets', market, checked as boolean)}
                />
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {['Website', 'Social Media', 'E-commerce', 'Mobile App', 'Email Marketing', 'Digital Advertising'].map((platform) => (
              <div key={platform} className="flex items-center space-x-2">
                <Checkbox
                  id={platform}
                  checked={businessData.digitalPresence.includes(platform)}
                  onCheckedChange={(checked) => handleCheckboxChange('digitalPresence', platform, checked as boolean)}
                />
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {['ISO Standards', 'CE Marking', 'FDA Approval', 'GDPR Compliance', 'Export Licensing', 'Quality Systems'].map((compliance) => (
              <div key={compliance} className="flex items-center space-x-2">
                <Checkbox
                  id={compliance}
                  checked={businessData.regulatoryCompliance.includes(compliance)}
                  onCheckedChange={(checked) => handleCheckboxChange('regulatoryCompliance', compliance, checked as boolean)}
                />
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {['ISO 9001', 'ISO 14001', 'OHSAS 18001', 'Organic Certification', 'Fair Trade', 'Industry Specific'].map((cert) => (
              <div key={cert} className="flex items-center space-x-2">
                <Checkbox
                  id={cert}
                  checked={businessData.qualityCertifications.includes(cert)}
                  onCheckedChange={(checked) => handleCheckboxChange('qualityCertifications', cert, checked as boolean)}
                />
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {['UK', 'Europe', 'North America', 'Asia Pacific', 'Middle East', 'Global'].map((region) => (
              <div key={region} className="flex items-center space-x-2">
                <Checkbox
                  id={region}
                  checked={businessData.targetRegions.includes(region)}
                  onCheckedChange={(checked) => handleCheckboxChange('targetRegions', region, checked as boolean)}
                />
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <Textarea
            ...
            placeholder="What are your main goals for business expansion? What do you hope to achieve?"
            rows={4}
          />
        </div>
